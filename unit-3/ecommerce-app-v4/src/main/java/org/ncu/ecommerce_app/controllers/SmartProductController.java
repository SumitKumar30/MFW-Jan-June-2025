...
public class SmartProductController {
	...
	@PostMapping("/save-smart-product")
    public ResponseEntity<String> addProduct(@RequestBody SmartProducts smartProducts) {
        smartProductService.saveSmartProduct(smartProducts);
        return ResponseEntity.ok("Smart Product with categories saved successfully");
    }
}
